...
import com.handmark.pulltorefresh.library.internal.BoxLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected LoadingLayout createLoadingLayout2(Context context, Mode mode, TypedArray attrs) {
		LoadingLayout layout = mLoadingAnimationStyle.createLoadingLayout2(context, mode,
				getPullToRefreshScrollDirection(), attrs);
		layout.setVisibility(View.INVISIBLE);
		return layout;
	}
	...
	private void init(Context context, AttributeSet attrs) {
		...
		mFooterLayout = createLoadingLayout2(context, Mode.PULL_FROM_END, a);
...
//			}
			...
			return new BoxLoadingLayout(context, mode, scrollDirection, attrs);
		}

		LoadingLayout createLoadingLayout2(Context context, Mode mode, Orientation scrollDirection, TypedArray attrs) {
//			switch (this) {
//				case ROTATE:
//				default:
//					return new RotateLoadingLayout(context, mode, scrollDirection, attrs);
